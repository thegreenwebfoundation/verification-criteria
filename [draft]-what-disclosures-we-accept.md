# DRAFT: What disclosures we accept for verification
...
* [We are a user/reseller of a provider that is already verified by the Green Web Foundation.](#we-use/resell-a-provider-that-is-already-verified-by-the-green-web-foundation.-can-my-organisation-get-verified-as-well?) 

* [We are a user/reseller of a provider that IS NOT verified by the Green Web Foundation.](#the-provider-i-use-is-not-verified-by-the-green-web-foundation,-but-they-use-fossil-free-energy.-how-can-my-organisation-get-verified?) 

* [We manage our own data center and/or infrastructure.](#what-disclosures-are-required-for-verification?)

---

The disclosure requirements for our verification have been chosen to align with existing standards such as the [RE100 Technical Criteria](https://www.there100.org/sites/re100/files/2025-04/RE100%20technical%20criteria%20%2B%20appendices%20%2815%20April%202025%29.pdf) and the [24-7 Carbon-Free Coalition (24-7 CFC) Technical Standard](https://www2.theclimategroup.org/247-technical-criteria-May-2025). Both are well established, agreed up standards to which many organisations (including data center operators and hosting companies) are parties to. Both require member organisations to report annually based on these criteria, and we hope this can provide a clear, repeatable disclosure pathway for providers going forwards.
...
1. A **public statement** from your organisation stating your commitment to achieving **100% hourly fossil-free energy use by 2030**, for every region in which you operate. This statement should also include information about the hosting infrastructure you currently use. We have prepared [this template to help you get started](https://www.thegreenwebfoundation.org/?page_id=10752).

2. Disclosures from one or more of the **basis for verification** criteria below:

   1. [**Self generation**](#self-generation-of-fossil-free-energy) \- you generate your own fossil-free energy.

   2. [**Direct procurement**](#direct-procurement-of-fossil-free-energy) \- you buy directly from a fossil-free energy project via a dedicated power purchase agreement*.*

   3. [**Green tariffs**](#green-tariffs) \- you actively procure a fossil-free energy tariff via electricity suppliers 

   4. [**Unbundled certificates**](#unbundled-certificates) \- you buy certificates of fossil-free generation separate from the power you buy, when you or your supplier can’t use one of the 3 ways above*.*
...
Our [Privacy Policy](https://www.thegreenwebfoundation.org/privacy-statement/) contains details about how our data is stored and processed.

### What bases of verification are accepted for listing in the Green Web Dataset?

Below are brief descriptions of each basis for verification. These are based on the definitions outlined in the Climate Groups’ [RE100 Technical Criteria](https://www.there100.org/sites/re100/files/2025-04/RE100%20technical%20criteria%20%2B%20appendices%20%2815%20April%202025%29.pdf) and the [24-7 Carbon-Free Coalition (24-7 CFC) Technical Standard](https://www2.theclimategroup.org/247-technical-criteria-May-2025). For detailed breakdowns, please refer to those documents.
...
1. Use the services of, or be a reseller of, a provider that is listed in our [Green Web Directory](https://www.thegreenwebfoundation.org/tools/directory/).

2. Disclosures that you have an active commercial relationship with them \- Share a recent invoice, contract, or similar documents. This can be uploaded as a [private item of disclosures](#transparency-of-disclosures). Sensitive information in these documents can be blacked out.
...
2. Demonstrate that the power used is matched with fossil-free energy generation by one of the mechanisms below:  
   1. [Self-generation](#self-generation-of-fossil-free-energy)  
   2. [Direct procurement](#direct-procurement-of-fossil-free-energy)  
   3. [Passive procurement](#passive-procurement-of-fossil-free-energy)  
   4. [Green tariffs](#green-tariffs)  
   5. [Unbundled certificates](#unbundled-certificates)  
   6. [Third-party limited assurance](#third-party-limited-assurance)
...
In the event they cannot obtain these disclosures from the provider they use/resell then they will need to share information about their energy usage, and evidence that they have purchased an equivalent amount of [unbundled certificates](#unbundled-certificates) for the time and region for which they are making the claim.
